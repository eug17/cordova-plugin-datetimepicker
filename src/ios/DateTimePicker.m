...
- (NSDate*)stringDateFromString:(NSString*)dateString;
...
- (void)configureDatePicker:(NSMutableDictionary *)optionsOrNil datePicker:(UIDatePicker *)datePicker;
{
    ...
    NSString *minDate = [optionsOrNil objectForKey:@"minDate"] == NULL ? [NSDate date]: [optionsOrNil objectForKey:@"minDate"];
    NSString *maxDate = [optionsOrNil objectForKey:@"maxDate"]  == NULL ? [NSDate date]: [optionsOrNil objectForKey:@"maxDate"];;
